...
impl Plugin for TaaPlugin {
    fn build(&self, app: &mut App) {
        app.add_plugin(SaveComponentPlugin::<MeshUniform>::default())
            ...
            .add_plugin(SaveComponentPlugin::<ExtractedView>::default())
            .add_plugin(UniformComponentPlugin::<
                Previous<ExtractedView>,
                Previous<ViewUniform>,
            >::new(|Previous(extracted)| {
                let projection = extracted.projection;
                let view_uniform = ViewUniform::new(
                    projection * extracted.transform.compute_matrix().inverse(),
                    projection,
                    extracted.transform.translation,
                );
                Previous(view_uniform)
            }));
...
// use bevy_app::{App, Plugin};
// use bevy_ecs::{component::Component, entity::Entity, prelude::{FromWorld, World}, schedule::ExclusiveSystemDescriptorCoercion, system::{Commands, IntoExclusiveSystem, Query, Res, ResMut}};
// use bevy_pbr2::MeshUniform;
// use bevy_render2::{RenderApp, RenderStage, render_component::UniformComponentPlugin, render_graph::RenderGraph, render_phase::{AddRenderCommand, DrawFunctions}, render_resource::{BindGroupLayout, BindGroupLayoutDescriptor, RenderPipeline, ShaderModule}, renderer::RenderDevice, shader::Shader, view::{ExtractedView, ViewUniform}};
// use bevy_utils::HashMap;
// use crevice::std140::AsStd140;
// use bevy_render2::{
...
//     render_phase::{
//         DrawFunctionId, PhaseItem, RenderCommand, RenderPhase, TrackedRenderPass,
//     },
//     render_resource::{
...
//         PrimitiveTopology, RenderPipelineDescriptor, ShaderStage,
